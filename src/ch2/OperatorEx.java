...
//        scanner.close();
        ...
        System.out.println("여러개의 문자열 변수에 저장된 내용을 한줄로 표현하고 싶을 경우 사용하는 것이 문자열 연결 연산자이다.");
        ...
        // 연산자의 우선 순위 때문에 왼쪽부터 차례대로 연산을 진행하여 문자열과 숫자의 연산이 먼저 발생하고, 그 이후에 문자열과 두번째 숫자과의
        // 연산이 발생하여 로세티리 바베큐 세트 65002000원 이라는 형태로 화면에 출력된다.
        System.out.println(menu + menu2 + price + price2 + "원");

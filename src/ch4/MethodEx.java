...
public class MethodEx {
    public static void main(String[] args) {
        ...
        // 사용자가 원하는 결과를 얻기 위한 소스코드를 한번 입력할 때는 문제가 없지만 여러번
        // 사용할 경우 소스코드의 중복이 발생함

        // 매개변수 : 해당 메서드 내의 연산 시 필요한 데이터를 외부에서 전달하는 변수
        // 반환값 : 해당 메서드의 연산 후 그 결과값을 매서드를 호출한 위치로 다시 되돌려주는 것, 키워드 return 사용

        // 메서드 사용법
        // 선언
        // 접근제한자 반환타입 매서드명(매개변수1, 매개변수2, ...) {
        //      실행할 소스코드
        // }
        // 사용(호출)
        // 매서드명(매개변수1, 매개변수2, ...);
        ...
        // 연산후 그 결과를 메서드 내부에서 표현함
        // 연산의 결과가 입력되는 데이터에따라 변경됨

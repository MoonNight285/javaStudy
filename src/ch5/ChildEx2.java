...
public class ChildEx2 {
    public static void main(String[] args) {
        // 자동 타입 변환
        // 부모 클래스 타입의 변수에 자식 클래스 타입의 객체를 대입하면 부모 클래스 타입의 맴버만
        // 사용이 가능함(알맹이는 자식 클래스 타입의 객체)
        ...
        System.out.println("\n ----- 자식 클래스 타입의 변수에 자식 클래스 타입의 객체 생성 대입 -----\n");
        ...
        child21.field1 = "Parent2 상속받은 맴버 변수";
        child21.field2 = "Child2 전용으로 가지고 있는 맴버 변수";
        ...
        // 원본 객체를 자식 클래스 타입의 변수로 타입 변환 시 해당 객체의 모든 맴버를 가지고 있는지
        // 알 수 없기 때문에 자동 강제 타입변환을 해야한다.
        ...
        // 1. 원본이 자식 클래스 타입이어야 해당하는 자식 클래스 타입으로 변환이 가능하다.
        // 원본이 부모 클래스 타입
        // Parent2 parent23 = new Parent2();
        // 자식 클래스 타입의 변수 선언
        // Child2 child23;
        // 사직 클래스 타입의 변수에 부모 클래스 타입의 객체를 대입
        // 문법상의 오류는 없으나 원본이 자식 클래스 타입의 객체가 아니기 때문에 런타임 에러가 발생한다.
        // child23 = (Child2) parent23;
        // 자식 클래스 타입의 객체의 맴버 사용
        // child23.method3();
